...
Bitmap* BigExplosion::m_BmpExplosionPtr = 0;


BigExplosion::BigExplosion(DOUBLE2 pos):
		Explosion(pos), m_Running(false)
{
	if (m_BmpExplosionPtr == 0)
	{
		m_BmpExplosionPtr= new Bitmap("./Resources/BigExplosion.png");
...
void BigExplosion::Tick(double deltaTime)
{
...
void BigExplosion::Paint(MATRIX3X2 matview)
{
	if(m_Running == true)
	{
		//MAKE MATRICES
...
void BigExplosion::Start(DOUBLE2 pos)
{
